...
public class painelD7 extends JPanel implements KeyListener, MouseListener{
	...
	public void paintComponent(Graphics g) {
		...
		if(this.Id_P == "centro") {
			...
			if(Player1_posX >= 450 && Player1_posY >= 200) {
	...
	public void keyPressed(KeyEvent e) {
		...
		this.repaint();
		System.out.println("Voc� liberou a tecla " + e.getKeyChar());
		System.out.println("Voc� liberou a tecla " + e.getKeyCode());
	}
