...
import java.awt.*;
public class painelD9 extends JPanel {
    ...
    public void paintComponent(Graphics desenho) {
        ...
        Font fonte1 = new Font ("TimesRoman", Font.BOLD, 37);
        Font fonte2 = new Font ("Arial", Font.ITALIC, 25);
        ...
        if(this.Id_P == 1) {
            ...
            //borda branca dos triangulos
            desenho2D.setStroke(new BasicStroke(4));
            desenho.setColor(Color.white);
            desenho.drawPolygon(pontosX_T1, pontosY_T1, 3);
            desenho.drawPolygon(pontosX_T2, pontosY_T2, 3);

            desenho2D.setStroke(new BasicStroke(1));
            desenho.setColor(Color.black);
            ...
            desenho2D.drawString("Autor: Alexandre e Wyllyan", 100, 100);

            desenho.setFont(fonte2);
            desenho.setColor(Color.blue);
            desenho.drawString("Autor:", 100, 50);
            desenho.setFont(fonte1);
            desenho.setColor(Color.black);
            desenho.drawString("Alexandre e Wyllyan", 170, 50);
        }
        else {
            desenho.setColor(Color.white);
